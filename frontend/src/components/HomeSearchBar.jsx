...
export default function HomeSearchBar() {
  ...
  const serviceOptions = {
    ...
    schemesAndServices: {
      label: "Find out what schemes and services are available",
      url: ""
    },
    registerBusiness: {
    ...
    servicesAndSupport: {
      label: "Find out more on services and support schemes",
      url: ""
    },
    ...
    marketInsights: {
      label: "Insights into market trends and consumer behaviour",
      url: ""
    },
    accessToFunding: {
    ...
    if (user === "Start-upOwner") {
      return (
        ...
        >
          ...
          <option value="schemesAndServices">Find out what schemes and services are available</option>
      ...
      return (
        ...
        >
          ...
          <option value="servicesAndSupport">Find out more on services and support schemes</option>
        </select>
      );
    } else if (user === "SME") {
      return (
        ...
        >
          ...
          <option value="marketInsights">Insights into market trends and consumer behaviour</option>
  ...
  const renderSelectedService = () => {
    ...
    return (
      <div className="mt-3">
        ...
        <a href={selectedOption.url} target="_blank" rel="noopener noreferrer" className="btn btn-primary">
          Visit Link
        </a>
      </div>
    );
